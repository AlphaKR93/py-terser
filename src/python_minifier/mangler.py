...
from python_minifier.transforms.local_reference_aliasing import LocalReferenceAliaser
from python_minifier.transforms.dynamic_import_renamer import DynamicImportRenamer
...
class Mangler:
    ...
    def mangle(self, module: ast.Module) -> ast.Module:
        ...
        if isinstance(self.config.obfuscation_map, dict):
            from python_minifier.rename.renamer import sorted_bindings
