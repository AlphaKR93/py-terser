...
class ExpressionPrinter(object):
    ...
    def visit_JoinedStr(self, node):
        ...
        self.printer.fstring(str(python_minifier.printer.strings.f_string.OuterFString(node, pep701=pep701)))

    def visit_TemplateStr(self, node):
        assert isinstance(node, ast.TemplateStr)

        import python_minifier.printer.strings.t_string

        self.printer.tstring(str(python_minifier.printer.strings.t_string.TString(node)))
