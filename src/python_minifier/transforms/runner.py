...
from python_minifier.transforms.contracts import Contracts
from python_minifier.transforms.inline_lambda_invoke import InlineLambdaInvoke
from python_minifier.transforms.remove_dummy_variables import RemoveDummyVariables
from python_minifier.transforms.remove_explicit_fields import RemoveExplicitFields
from python_minifier.transforms.remove_dead_blocks import RemoveDeadBlocks
from python_minifier.transforms.remove_docstrings import RemoveDocstrings
from python_minifier.transforms.remove_overloads import RemoveOverloads
from python_minifier.transforms.remove_explicit_inherits import RemoveExplicitInherits
from python_minifier.transforms.remove_bare_protocols import RemoveBareProtocols
from python_minifier.transforms.remove_generics import RemoveGenerics
...
from python_minifier.transforms.remove_type_stmt import RemoveTypeStmt
from python_minifier.transforms.remove_trailing_returns import RemoveTrailingReturns
from python_minifier.transforms.simplify_posargs import SimplifyPositionArguments
from python_minifier.transforms.simplify_dynamic_attrs import SimplifyDynamicAttributes
from python_minifier.transforms.simplify_fstring import SimplifyFString
from python_minifier.transforms.simplify_early_exit import SimplifyEarlyExit
from python_minifier.transforms.simplify_raise import SimplifyRaise
from python_minifier.transforms.simplify_if_stmt import SimplifyIfStmt
from python_minifier.transforms.convert_to_ternary import ConvertToTernary
from python_minifier.transforms.convert_to_lambda import ConvertToLambda
...
from python_minifier.transforms.remove_typing_decorators import RemoveTypingDecorators
from python_minifier.transforms.inline_functions import InlineFunctions
from python_minifier.transforms.inline_int_flags import InlineIntFlags
from python_minifier.transforms.cleanup_imports import CleanupImports
    ...
    def run(self, module: ast.Module) -> ast.Module:
        ...
        passes = [
            ...
            (self.config.remove_annotations, lambda: RemoveAnnotations(
                options=__import__("python_minifier.transforms.remove_annotations_options", fromlist=["RemoveAnnotationsOptions"]).RemoveAnnotationsOptions(
