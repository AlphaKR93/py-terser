...
from python_minifier._ast.annotation import get_parent, add_parent as add_node_parent
...
class SuiteTransformer(NodeVisitor):
    ...
    def clean_suite(self, visited_list, parent):
        cleaned = []
    ...
    def suite(self, node_list, parent):
        return self.clean_suite([self.visit(node) for node in node_list if node is not None], parent)
    ...
    def add_child(self, child, parent, namespace=None):
        ...
        from python_minifier.rename.mapper import add_parent as rename_add_parent
