    ...
    def complete_debug_specifier(self, partial_specifier_candidates, value_node):
        ...
        if value_node.format_spec is not None:
            ...
            if isinstance(value_node.format_spec, ast.JoinedStr):
                ...
                format_specs = terser._pipeline.printer.string.f_string.FormatSpec(value_node.format_spec, self.allowed_quotes, pep701=True).candidates()
...
class InterpolationValue(ExpressionPrinter):
    ...
    def get_candidates(self):
        ...
        if self.node.format_spec is not None:
            ...
            if isinstance(self.node.format_spec, ast.JoinedStr):
                ...
                format_candidates = terser._pipeline.printer.string.f_string.OuterFString(
    ...
    def visit_Constant(self, node):
        ...
        if isinstance(node.value, str):
            ...
            from terser._pipeline.printer.string.f_string import Str
            ...
            from terser._pipeline.printer.string.f_string import Bytes
    ...
    def visit_JoinedStr(self, node):
        ...
        self._append(terser._pipeline.printer.string.f_string.OuterFString(node, pep701=True).candidates())
