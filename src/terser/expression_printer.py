...
from terser.token_printer import Delimiter, TokenPrinter
...
class ExpressionPrinter(object):
    ...
    def visit_JoinedStr(self, node):
        ...
        self.printer.fstring(str(terser.f_string.OuterFString(node, pep701=pep701)))

    def visit_TemplateStr(self, node):
        assert isinstance(node, ast.TemplateStr)

        import terser.t_string

        self.printer.tstring(str(terser.t_string.TString(node)))
