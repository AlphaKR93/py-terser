...
from terser.preprocessor import Preprocessor, PreprocessResult
from terser.parser import Parser, ParseResult
from terser.linker import Linker
from terser.transforms.runner import TransformRunner
from terser.mangler import Mangler
...
class Pipeline:
    ...
    def _print_module(self, module: ast.Module, prep: PreprocessResult) -> str:
        ...
        # AST stability check
        try:
            reparsed = ast.parse(minified, 'terser.unparse output')
